...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, RS_Pin|D7_Pin|RW_Pin|E_Pin
                          |D4_Pin|D5_Pin|D6_Pin|D3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RS_Pin D7_Pin RW_Pin E_Pin
                           D4_Pin D5_Pin D6_Pin D3_Pin */
  GPIO_InitStruct.Pin = RS_Pin|D7_Pin|RW_Pin|E_Pin
                          |D4_Pin|D5_Pin|D6_Pin|D3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
